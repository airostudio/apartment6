...
(function() {
  ...
  const Admin = {
    ...
    /**
     * Sidebar toggle for mobile — auto-injects button if not present in HTML
     */
    initSidebar() {
      const sidebar = document.querySelector('.admin-sidebar');
      if (!sidebar) return;

      // Auto-inject the hamburger toggle into the topbar if not already present
      ...
      if (!toggle) {
        ...
        if (topbar) {
          ...
          toggle.innerHTML = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" width="20" height="20"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg>';
